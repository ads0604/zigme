...
<body>
	<div class="container">
		...
		<div class="body col-lg-7">
			<span class="sub_title">메뉴 추천 > 건강상태별</span>
		...
		*/    	
		function menu_item(count) {    		
        	...
        	for(var i=0; i < count; i++) {
        		result += "<li><div class='menu_iconarea' id='menu_group_" + i + "'><img class='menu_icon' src='${pageContext.request.contextPath}/img/menu/sick_" + i + ".png' width=" 
